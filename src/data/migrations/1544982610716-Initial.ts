...
export class Initial1544982610716 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `roles` (`rolesID` int NOT NULL AUTO_INCREMENT, `role` varchar(40) NOT NULL, PRIMARY KEY (`rolesID`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `users` (`userID` int NOT NULL AUTO_INCREMENT, `email` varchar(100) NOT NULL, `password` varchar(200) NOT NULL, `username` varchar(20) NOT NULL, `firstName` varchar(35) NOT NULL, `lastName` varchar(35) NULL, `receivedFeedbacks` int NULL, `givenFeedbacks` int NULL, PRIMARY KEY (`userID`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `roles_user_users` (`rolesRolesID` int NOT NULL, `usersUserID` int NOT NULL, PRIMARY KEY (`rolesRolesID`, `usersUserID`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `roles_user_users` ADD CONSTRAINT `FK_cf2b3ceeecd8512fcb6bc1d0978` FOREIGN KEY (`rolesRolesID`) REFERENCES `roles`(`rolesID`) ON DELETE CASCADE");
        await queryRunner.query("ALTER TABLE `roles_user_users` ADD CONSTRAINT `FK_dc4f79c998eff776d2138bd2e0e` FOREIGN KEY (`usersUserID`) REFERENCES `users`(`userID`) ON DELETE CASCADE");
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `roles_user_users` DROP FOREIGN KEY `FK_dc4f79c998eff776d2138bd2e0e`");
        await queryRunner.query("ALTER TABLE `roles_user_users` DROP FOREIGN KEY `FK_cf2b3ceeecd8512fcb6bc1d0978`");
        ...
        await queryRunner.query("DROP TABLE `roles_user_users`");

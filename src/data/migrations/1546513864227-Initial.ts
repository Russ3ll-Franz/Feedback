...
export class Initial1546513864227 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `feedbacklog` (`feedbacklogID` int NOT NULL AUTO_INCREMENT, `feedback` varchar(1000) NOT NULL, `teamID` int NOT NULL, `receiverUserID` int NULL, `senderUserID` int NULL, PRIMARY KEY (`feedbacklogID`)) ENGINE=InnoDB");

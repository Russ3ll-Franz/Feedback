...
export class Initiall1544901268266 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`userID` int NOT NULL AUTO_INCREMENT, `email` varchar(100) NULL, `password` varchar(200) NULL, `username` varchar(20) NULL, `firstName` varchar(35) NULL, `lastName` varchar(35) NULL, `receivedFeedbacks` int NULL, `givenFeedbacks` int NULL, `role` varchar(255) NOT NULL DEFAULT 'User', PRIMARY KEY (`userID`)) ENGINE=InnoDB");

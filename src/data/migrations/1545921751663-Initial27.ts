...
export class Initial271545921751663 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `feedbacklog__feedbacklog_teams` ADD CONSTRAINT `FK_36447bb7c67cb9cb37d9af1602e` FOREIGN KEY (`feedbacklogFeedbacklogID`) REFERENCES `feedbacklog`(`feedbacklogID`) ON DELETE CASCADE");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `feedbacklog__feedbacklog_teams` DROP FOREIGN KEY `FK_36447bb7c67cb9cb37d9af1602e`");
